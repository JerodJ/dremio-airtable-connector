...
@SourceType(value = "AirtableARP", label = "Airtable",uiConfig = "airtable-layout.json")
public class AirtableConf extends AbstractArpConf<AirtableConf> {
  private static final String ARP_FILENAME = "arp/implementation/airtable-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.airtable.AirtableDriver";
