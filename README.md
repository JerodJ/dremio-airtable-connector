...
3. Download and install the [Airtable JDBC Driver from CData](https://www.cdata.com/drivers/airtable/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
